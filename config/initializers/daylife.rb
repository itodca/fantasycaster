...
module Daylife
  class API
    ...
    def execute(service_name, method_name, parameters = {}, source_blacklist = [])
      ...
      param_string = "#{param_string}&#{source_blacklist.map{|s| "source_blacklist=#{s}"}.join("&")}" if source_blacklist
